              ...
              >
                ...
                <div className="absolute bottom-0 w-full flex flex-col items-center">
                  <div
                    onMouseEnter={() => setIsPointerOverButton(true)}
                    onMouseLeave={() => setIsPointerOverButton(false)}
                    className="px-8 py-1 text-sm text-center pointer-events-auto bg-gray-700/70 text-white m-2 rounded-full"
                  >
        ...
        {image && (
          <div
            className={cn(
              ...
              !showInfo
                ? "max-h-0 h-0 lg:max-w-0 xl:max-w-0 lg:max-h-full lg:h-full"
          ...
          >
            <div
              className={cn(
                ...
                !image ? "justify-start items-center" : undefined,
              )}
            >
              <div className="lg:bg-gray-100 lg:dark:bg-gray-800 rounded-lg p-2 min-w-full">
                <button
                  onClick={handleClose}
                ...
                <div className="grow overflow-y-auto py-1 px-2">
                  ...
                  >
                    <h1 className="text-lg font-semibold">{image.info.name}</h1>
                  </div>
